...
#define CMDLS_ON	0    // dereferencing pointer to incomplete type ‘struct fs_diriteminfo’
#define CMDCP_ON	0    // needs b_io.c file to work
#define CMDMV_ON	0    // implement move function
#define CMDMD_ON	0    // debug make directory
#define CMDRM_ON	0    // debug/ referrence issue
#define CMDCP2L_ON	1    // needs b_io.c file to work
#define CMDCP2FS_ON	1    // needs b_io.c file to work
#define CMDCD_ON	0    // debug cd directory funtions
#define CMDPWD_ON	0    // debug pwd directory funtions
#define CMDTOUCH_ON	1    // needs b_io.c file to work
#define CMDCAT_ON	1    // needs b_io.c file to work
